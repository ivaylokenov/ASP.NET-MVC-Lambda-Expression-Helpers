namespace System.Web.Mvc.Expressions
{
    ...
    public static class ControllerExtensions
    {
        ...
        public static RedirectToRouteResult RedirectToAction<TController, TRedirectController>(this TController controller, Expression<Action<TRedirectController>> action, object routeValues = null)
            where TController : Controller
        ...
        private static RedirectToRouteResult GetRedirectFromExpression<TRedirectController>(Expression<Action<TRedirectController>> action, object routeValues = null)
            where TRedirectController : Controller
        {
